...
| Model | CLI | Used in |
|-------|-----|---------|
| Claude Opus 4.7 | Built-in (Task tool) | Stages 1, 4 |
| GPT 5.5 | [Codex CLI](https://github.com/openai/codex) (`codex`) | Stages 1, 4 |
...
2. Dispatch 3 models in parallel (Opus 4.7, GPT 5.5, Gemini 3 Pro) with all review categories (codebase match, security, design quality, performance, etc.)
